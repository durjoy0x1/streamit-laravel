!(function () {
  ...
  g('1', [], function () {
    ...
    g('b', [], function () {
      var a = function (a, b) {
        return a.fire('VisualChars', { state: b })
      }
      return { fireVisualChars: a }
    }),
    g('c', [], function () {
      ...
      return { charMap: a, regExp: b(a), regExpGlobal: b(a, !0), selector: c(a), charMapToRegExp: b, charMapToSelector: c }
    }),
    h('i', Array),
    h('j', Error),
    g('l', ['i', 'j'], function (a, b) {
      var c = function () {},
        d = function (a, b) {
          return function () {
    ...
    g('5', ['9', 'a'], function (a, b) {
      var c = function (c, d) {
        ...
        c.settings.forced_root_block !== !1 &&
    ...
    g('6', [], function () {
      var a = function (a) {
        ...
        b = function (b) {
          b.addButton('visualchars', { active: !1, title: 'Show invisible characters', cmd: 'mceVisualChars', onPostRender: a(b) }), b.addMenuItem('visualchars', { text: 'Show invisible characters', cmd: 'mceVisualChars', onPostRender: a(b), selectable: !0, context: 'view', prependToContext: !0 })
        }
      return { register: b }
    }),
    g('0', ['1', '2', '3', '4', '5', '6'], function (a, b, c, d, e, f) {
      return (
        b.add('visualchars', function (b) {
          var g = a(!1)
